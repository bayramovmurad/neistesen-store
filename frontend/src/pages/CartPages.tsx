  ...
  return (
    <div className="text-left">
      <h1 className="mb-8 flex items-center gap-2 text-3xl font-bold text-base-content">
        <ShoppingCartIcon className="size-8 text-blue-700" aria-hidden />
        Cart
      </h1>
          ...
          <aside className="card border border-base-300 bg-base-100 p-6 shadow-md">
            ...
            <Show when="signed-in">
              <button
                ...
                className="btn btn-blue-900 mt-6 w-full gap-2">
                {checkoutLoading ? (
                  <span
            ...
            <Show when="signed-out">
              <SignInButton mode="modal">
                <button
                  type="button"
                  className="btn btn-outline btn-blue-900 mt-6 w-full gap-2">
