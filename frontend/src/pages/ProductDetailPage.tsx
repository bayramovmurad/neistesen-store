      ...
      <div className="mt-6 grid gap-10 lg:grid-cols-2 lg:gap-14">
        ...
        <div className="flex flex-col text-left">
          <div className="flex flex-wrap items-center gap-2">
            <span className="badge bg-blue-700 badge-outline">{category}</span>
          ...
          <p className="mt-3 text-3xl font-bold tabular-nums text-blue-700 md:text-4xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <button
              ...
              className="btn bg-blue-700 btn-lg gap-2 shadow-lg">
